...
class PrinterWiFiInner {
    ...
    fun TSCPrintLabel(innerCarton: InnerCarton, CrossReferenceNotext: String, CountryofOrigintext:String) {
        try {
            val A = "3010144000-HB1-210409-00008"
            TSCcommand!!.openport("192.168.10.173", 9100)
            ...
            TSCcommand!!.sendcommand("TEXT 760,553,\"3\",180,1,1,\"Mfr P/N:\"\r\n")
            TSCcommand!!.sendcommand("TEXT 601,553,\"3\",180,1,1,\"${innerCarton.CSPN}\"\r\n")
            TSCcommand!!.sendcommand("TEXT 116,562,\"3\",180,1,1,\"${innerCarton.LineNo}\"\r\n")
            TSCcommand!!.barcode(760, 496, "128", 53, 0, 180, 2, 4, innerCarton.CSPN)

            TSCcommand!!.sendcommand("TEXT 760,403,\"3\",180,1,1,\"P/N:\"\r\n")
            TSCcommand!!.sendcommand("TEXT 601,403,\"3\",180,1,1,\"${CrossReferenceNotext}\"\r\n")
            TSCcommand!!.barcode(760, 345, "128", 53, 0, 180, 2, 4, CrossReferenceNotext)
            TSCcommand!!.sendcommand("TEXT 760,259,\"3\",180,1,1,\"Mfr P/N:\"\r\n")
            TSCcommand!!.sendcommand("TEXT 601,259,\"3\",180,1,1,\"${innerCarton.CSPN}\"\r\n")
            TSCcommand!!.barcode(760, 202, "128", 53, 0, 180, 2, 4, innerCarton.CSPN)
            TSCcommand!!.sendcommand("TEXT 106,327,\"3\",180,1,1,\"${innerCarton.Quantity}\"\r\n")
