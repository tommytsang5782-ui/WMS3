                ...
                for (i in 0..(DC_SmallCarton.size - 1)) {
                    ...
                    if (DC_SmallCartonData.isNotEmpty()) {
                        ...
                        for (i in 0..mutableList.size - 1) {
                            if ((mutableList[i].ItemNo == ItemNO) &&
                                    (mutableList[i].CartonID == DC_SmallCartonData[0]) &&
                                    (mutableList[i].LotNo == DC_SmallCartonData[1]) &&
                                    (mutableList[i].DateCode == DC_SmallCartonData[2]))
                            {
                                mutableList[i].Quantity = mutableList[i].Quantity + DC_SmallCartonData[3].toInt()
                                booNewCarton = false
                            }
                        }
                        if (booNewCarton) {
